...
parser.add_argument('--annotation', type=str, default='./data/mimic_cxr/annotation.json', help="annotation file of the dataset")
...
parser.add_argument('--lora_X', action='store_true', default=False,  help='启用对X投影的LoRA适配')
parser.add_argument('--dim_X', type=int, default=32,  help='LoRA X适配器的维度')
parser.add_argument('--s_X', type=float, default=1.0,  help='LoRA X的缩放因子')

parser.add_argument('--use_hybrid_decoder', action='store_true', help='Whether to use hybrid decoder layers')
parser.add_argument('--cross_attn_every_n_layers', type=int, default=8, help='Add cross-attention every n layers')
parser.add_argument('--cross_attn_implementation', type=str, default='vanilla',
                    help='Implementation of cross-attention')


# ======================== SavedModel Configs ===========================
parser.add_argument('--savedmodel_path', type=str, default='save/chexpert_plus/v1')
