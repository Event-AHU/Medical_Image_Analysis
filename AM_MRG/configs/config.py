...
parser.add_argument('--llm_path', default='Meta/Llama-2-7b-chat-hf', type=str)
parser.add_argument('--type', default='large', type=str)
parser.add_argument('--stageone_path', default='configs/Stage1ckpt.pth', type=str)
parser.add_argument('--class_activation_maps_path', default='configs/CAM.pkl', type=str)
...
parser.add_argument('--maps_num', default=500, type=int)
parser.add_argument('--scaling', default=4.0, type=float)
parser.add_argument('--report_memory_path', default='configs/Report_Memory.pkl', type=str)
parser.add_argument('--report_total_samples', default=6000, type=int)
