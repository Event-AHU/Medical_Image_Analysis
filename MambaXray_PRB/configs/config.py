...
parser.add_argument('--type', default='base', type=str)
...
parser.add_argument('--cot', default=True, help="reort or (CoT+report)")
parser.add_argument('--thinking_length', default=100, type=int, help="CoT length")
parser.add_argument('--report_loss_weight', default=1.0, type=float, help="report loss权重")
parser.add_argument('--thinking_loss_weight', default=1.0, type=float, help="thinking loss权重")
parser.add_argument('--thinking_max_new_tokens', default=200, type=int, help="思维链最大生成长度")
parser.add_argument('--thinking_min_new_tokens', default=0, type=int, help="思维链最小生成长度")
# ========================= Model Settings ============================
