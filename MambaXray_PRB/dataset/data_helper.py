...
class FieldParser:
    ...
    def clean_report(self, report): # 数据清洗
        ...
        else: # mimic-cxr和chexpert-plus和CoT-cxp
    ...
    def parse(self, features):
        ...
        if self.dataset == "chinese":
            ...
            report = self.clean_report(report)
            if self.args.cot:
                HumanLikeReasoning = features.get("HumanLikeReasoning", "")
                if HumanLikeReasoning == "":
                    pass
                else:
                    to_return['thinking'] = self.clean_report(HumanLikeReasoning)
            else:
                pass
...
class ParseDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """{
            "id": "train_patient38896_study4_view1_frontal",
            "report": " ......",
            "image_path": [
                "train/patient38896/study4/view1_frontal.jpg"
            ],
            "base_path": "/data/datasets/cheXpert_plus/PNG",
            "HumanLikeReasoning": "......",
            "split": "train"
        }"""
