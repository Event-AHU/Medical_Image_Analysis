...
#  新加 ========================= GCN Settings ============================
parser.add_argument('--node_features3', type=str, default=r'300/319_node.pt', help="node_features")
parser.add_argument('--edge_index3', type=str, default=r'300/edge_index.pt', help="edge_index")
parser.add_argument('--edge_type3', type=str, default=r'300/edge_type.pt', help="edge_type")

parser.add_argument('--node_features1', type=str, default=r'100/101_node.pt', help="node_features")
parser.add_argument('--edge_index1', type=str, default=r'100/edge_index.pt', help="edge_index")
parser.add_argument('--edge_type1', type=str, default=r'100/edge_type.pt', help="edge_type")

parser.add_argument('--node_features2', type=str, default=r'200/206_node.pt', help="node_features")
parser.add_argument('--edge_index2', type=str, default=r'200/edge_index.pt', help="edge_index")
parser.add_argument('--edge_type2', type=str, default=r'200/edge_type.pt', help="edge_type")

parser.add_argument('--node_features4', type=str, default=r'400/400_node.pt', help="node_features")
parser.add_argument('--edge_index4', type=str, default=r'400/edge_index.pt', help="edge_index")
parser.add_argument('--edge_type4', type=str, default=r'400/edge_type.pt', help="edge_type")

parser.add_argument('--node_features5', type=str, default=r'500/558_node.pt', help="node_features")
parser.add_argument('--edge_index5', type=str, default=r'500/edge_index.pt', help="edge_index")
parser.add_argument('--edge_type5', type=str, default=r'500/edge_type.pt', help="edge_type")


#  新加 ========================= visual_check Settings ============================")
parser.add_argument('--disease_feature', type=str, default=r'cam_features.pt', help="disease_feature")
...
# ========================= Learning Configs ==========================
parser.add_argument('--learning_rate', default=0.9e-4, type=float, help='initial learning rate')
